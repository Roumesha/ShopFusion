      ...
      <div className='h-full container mx-auto flex items-center px-4 justify-between'>
        <div className='flex items-center'>
          <a href="/" className='flex items-center'>
            <img src="https://img.pikbest.com/png-images/ecommerce-logo-vector-graphics-element--e-commerce-logo-icon-design-online-store-logo-icon_1726010.png!sw800" alt="Logo" width="70" height="40" />
            <h6 style={{ marginLeft: '8px', fontSize: '18px', fontWeight: 'bold', color: '#333' }}>Shop Fusion</h6><br></br>
          </a>
        </div>
